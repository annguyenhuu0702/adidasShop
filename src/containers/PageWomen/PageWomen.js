...
function PageWomen() {
  return (
    <section className="page-women">
      ...
      <div className="page-women__menu">
        <div className="container">
          ...
          <div className="menu__wrap">
            <ul>
              ...
              <li>
                <Link to="/giay-nu">GIÀY</Link>
              </li>
              <li>
                <Link to="/quan-ao-nu">QUẦN ÁO</Link>
              </li>
              <li>
                <Link to="/phu-kien-nu">PHỤ KIỆN</Link>
              </li>
              <li>
                <Link to="/san-pham-nu">TẤT CẢ SẢN PHẨM</Link>
              </li>
            </ul>
          </div>
        </div>
